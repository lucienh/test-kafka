...
public class KafkaLowlevelConsumerTest {

    private List<String> borkerList = new ArrayList<String>();

    public KafkaLowlevelConsumerTest() {
        borkerList = new ArrayList<String>();
    }

    public static void main(String args[]) {
        KafkaLowlevelConsumerTest kafkaSimpleConsumer = new KafkaLowlevelConsumerTest();
        // 最大读取消息数量  
        long maxReadNum = Long.parseLong("3");
        // 订阅的topic  
        String topic = "riskIp06";
        // 查找的分区  
